...
static const char *keymap_names[] = {"latin", "cyrillic", "french", "english"};
...
",
  ...
  // FRENCH (generated by xkb-to-wvkbd.py fr)
"xkb_keymap {\n"
"xkb_keycodes \"evdev_aliases(azerty)\" {\n"
"	minimum = 8;\n"
"	maximum = 709;\n"
"	<ESC>                = 9;\n"
"	<AE01>               = 10;\n"
...
"};\n",
  ...
  // ENGLISH (generated by xkb-to-wvkbd.py us altgr-intl)
"xkb_keymap {\n"
...
"};\n"
"\n"
"xkb_symbols \"pc_us(altgr-intl)_inet(evdev)\" {\n"
"	name[1]=\"English (intl., with AltGr dead keys)\";\n"
"\n"
"	key <ESC>                {	[          Escape ] };\n"
