...
static struct key keys_full[], keys_azerty[], keys_symbols_fr[], keys_symbols_us[], keys_cyrillic[],
  keys_compose_a[],
...
static struct layout layouts[NumLayouts] = {
  [Full] = {keys_full, "english", "qwerty", true},
  [Azerty] = {keys_azerty, "french", "azerty", true}, // French AZERTY, uses the fr xkb keymap // second parameter is the keymap name
                                         // third parameter is the layout name
										 // last parameter indicates if it's an alphabetical/primary layout
  [SymbolsFr] = {keys_symbols_fr, "french", "symboles", false},
  [SymbolsUs] = {keys_symbols_us, "english", "symbols", false},
...
static struct key keys_full[] = {
  ...
  {"`", "~", 1.0, Code, KEY_GRAVE, .altgr_label = "`", .altgr_shift_label = "~"},
  {"1", "!", 1.0, Code, KEY_1, .altgr_label = "¹", .altgr_shift_label = "¡"},
  {"2", "@", 1.0, Code, KEY_2, .altgr_label = "²", .altgr_shift_label = "˝"},
  {"3", "#", 1.0, Code, KEY_3, .altgr_label = "³", .altgr_shift_label = "¯"},
  {"4", "$", 1.0, Code, KEY_4, .altgr_label = "¤", .altgr_shift_label = "£"},
  {"5", "%", 1.0, Code, KEY_5, .altgr_label = "€", .altgr_shift_label = "¸"},
  {"6", "^", 1.0, Code, KEY_6, .altgr_label = "^", .altgr_shift_label = "¼"},
  {"7", "&", 1.0, Code, KEY_7, .altgr_label = "◌̛", .altgr_shift_label = "½"},
  {"8", "*", 1.0, Code, KEY_8, .altgr_label = "˛", .altgr_shift_label = "¾"},
  {"9", "(", 1.0, Code, KEY_9, .altgr_label = "‘", .altgr_shift_label = "˘"},
  {"0", ")", 1.0, Code, KEY_0, .altgr_label = "’", .altgr_shift_label = "˚"},
  {"-", "_", 1.0, Code, KEY_MINUS, .altgr_label = "¥", .altgr_shift_label = "◌̣"},
  {"=", "+", 1.0, Code, KEY_EQUAL, .altgr_label = "×", .altgr_shift_label = "÷"},
  {"⌫", "⌫", 1.5, Code, KEY_BACKSPACE, .scheme = 1},
  {"", "", 0.0, EndRow},

  {"Tab", "Tab", 1.5, Code, KEY_TAB, .scheme = 1},
  {"q", "Q", 1.0, Code, KEY_Q, .altgr_label = "ä", .altgr_shift_label = "Ä"},
  {"w", "W", 1.0, Code, KEY_W, .altgr_label = "å", .altgr_shift_label = "Å"},
  {"e", "E", 1.0, Code, KEY_E, .altgr_label = "é", .altgr_shift_label = "É"},
  {"r", "R", 1.0, Code, KEY_R, .altgr_label = "ë", .altgr_shift_label = "Ë"},
  {"t", "T", 1.0, Code, KEY_T, .altgr_label = "þ", .altgr_shift_label = "Þ"},
  {"y", "Y", 1.0, Code, KEY_Y, .altgr_label = "ü", .altgr_shift_label = "Ü"},
  {"u", "U", 1.0, Code, KEY_U, .altgr_label = "ú", .altgr_shift_label = "Ú"},
  {"i", "I", 1.0, Code, KEY_I, .altgr_label = "í", .altgr_shift_label = "Í"},
  {"o", "O", 1.0, Code, KEY_O, .altgr_label = "ó", .altgr_shift_label = "Ó"},
  {"p", "P", 1.0, Code, KEY_P, .altgr_label = "ö", .altgr_shift_label = "Ö"},
  {"[", "{", 1.0, Code, KEY_LEFTBRACE, .altgr_label = "«", .altgr_shift_label = "“"},
  {"]", "}", 1.0, Code, KEY_RIGHTBRACE, .altgr_label = "»", .altgr_shift_label = "”"},
  {"\\", "|", 1.0, Code, KEY_BACKSLASH, .altgr_label = "¬", .altgr_shift_label = "¦"},
  {"", "", 0.0, EndRow},

  {"Caps", "Caps", 1.75, Mod, CapsLock, .scheme = 1},
  {"a", "A", 1.0, Code, KEY_A, .altgr_label = "á", .altgr_shift_label = "Á"},
  {"s", "S", 1.0, Code, KEY_S, .altgr_label = "ß", .altgr_shift_label = "§"},
  {"d", "D", 1.0, Code, KEY_D, .altgr_label = "ð", .altgr_shift_label = "Ð"},
  {"f", "F", 1.0, Code, KEY_F, .altgr_label = "f", .altgr_shift_label = "F"},
  {"g", "G", 1.0, Code, KEY_G, .altgr_label = "g", .altgr_shift_label = "G"},
  {"h", "H", 1.0, Code, KEY_H, .altgr_label = "h", .altgr_shift_label = "H"},
  {"j", "J", 1.0, Code, KEY_J, .altgr_label = "ï", .altgr_shift_label = "Ï"},
  {"k", "K", 1.0, Code, KEY_K, .altgr_label = "œ", .altgr_shift_label = "Œ"},
  {"l", "L", 1.0, Code, KEY_L, .altgr_label = "ø", .altgr_shift_label = "Ø"},
  {";", ":", 1.0, Code, KEY_SEMICOLON, .altgr_label = "¶", .altgr_shift_label = "°"},
  {"'", "\"", 1.0, Code, KEY_APOSTROPHE, .altgr_label = "´", .altgr_shift_label = "¨"},
  {"Enter", "Enter", 1.75, Code, KEY_ENTER, .scheme = 1},
  {"", "", 0.0, EndRow},

  {"⇧", "⇫", 1.75, Mod, Shift, .scheme = 1},
  {"z", "Z", 1.0, Code, KEY_Z, .altgr_label = "æ", .altgr_shift_label = "Æ"},
  {"x", "X", 1.0, Code, KEY_X, .altgr_label = "œ", .altgr_shift_label = "Œ"},
  {"c", "C", 1.0, Code, KEY_C, .altgr_label = "©", .altgr_shift_label = "¢"},
  {"v", "V", 1.0, Code, KEY_V, .altgr_label = "®", .altgr_shift_label = "™"},
  {"b", "B", 1.0, Code, KEY_B, .altgr_label = "·"},
  {"n", "N", 1.0, Code, KEY_N, .altgr_label = "ñ", .altgr_shift_label = "Ñ"},
  {"m", "M", 1.0, Code, KEY_M, .altgr_label = "µ", .altgr_shift_label = "±"},
  {",", "<", 1.0, Code, KEY_COMMA, .altgr_label = "ç", .altgr_shift_label = "Ç"},
  {".", ">", 1.0, Code, KEY_DOT, .altgr_label = "˙", .altgr_shift_label = "ˇ"},
  {"/", "?", 1.0, Code, KEY_SLASH, .altgr_label = "¿", .altgr_shift_label = "◌̉"},
...
static struct key keys_azerty[] = {
  ...
  {"²", "~", 1.0, Code, KEY_GRAVE, .altgr_label = "¬", .altgr_shift_label = "¬"},
  {"&", "1", 1.0, Code, KEY_1, .altgr_label = "¹", .altgr_shift_label = "¡"},
  {"é", "2", 1.0, Code, KEY_2, .altgr_label = "~", .altgr_shift_label = "⅛"},
  {"\"", "3", 1.0, Code, KEY_3, .altgr_label = "#", .altgr_shift_label = "£"},
  {"'", "4", 1.0, Code, KEY_4, .altgr_label = "{", .altgr_shift_label = "$"},
  {"(", "5", 1.0, Code, KEY_5, .altgr_label = "[", .altgr_shift_label = "⅜"},
  {"-", "6", 1.0, Code, KEY_6, .altgr_label = "|", .altgr_shift_label = "⅝"},
  {"è", "7", 1.0, Code, KEY_7, .altgr_label = "`", .altgr_shift_label = "⅞"},
  {"_", "8", 1.0, Code, KEY_8, .altgr_label = "\\", .altgr_shift_label = "™"},
  {"ç", "9", 1.0, Code, KEY_9, .altgr_label = "^", .altgr_shift_label = "±"},
  {"à", "0", 1.0, Code, KEY_0, .altgr_label = "@", .altgr_shift_label = "°"},
  {")", "°", 1.0, Code, KEY_MINUS, .altgr_label = "]", .altgr_shift_label = "¿"},
  {"=", "+", 1.0, Code, KEY_EQUAL, .altgr_label = "}", .altgr_shift_label = "˛"},
  {"⌫", "⌫", 1.5, Code, KEY_BACKSPACE, .scheme = 1},
  {"", "", 0.0, EndRow},

  {"Tab", "Tab", 2.5, Code, KEY_TAB, .scheme = 1},
  {"a", "A", 1.0, Code, KEY_Q, .altgr_label = "æ", .altgr_shift_label = "Æ"},
  {"z", "Z", 1.0, Code, KEY_W, .altgr_label = "«", .altgr_shift_label = "<"},
  {"e", "E", 1.0, Code, KEY_E, .altgr_label = "€", .altgr_shift_label = "¢"},
  {"r", "R", 1.0, Code, KEY_R, .altgr_label = "¶", .altgr_shift_label = "®"},
  {"t", "T", 1.0, Code, KEY_T, .altgr_label = "ŧ", .altgr_shift_label = "Ŧ"},
  {"y", "Y", 1.0, Code, KEY_Y, .altgr_label = "←", .altgr_shift_label = "¥"},
  {"u", "U", 1.0, Code, KEY_U, .altgr_label = "↓", .altgr_shift_label = "↑"},
  {"i", "I", 1.0, Code, KEY_I, .altgr_label = "→", .altgr_shift_label = "ı"},
  {"o", "O", 1.0, Code, KEY_O, .altgr_label = "ø", .altgr_shift_label = "Ø"},
  {"p", "P", 1.0, Code, KEY_P, .altgr_label = "þ", .altgr_shift_label = "Þ"},
  {"^", "¨", 1.0, Code, KEY_LEFTBRACE, .altgr_label = "¨", .altgr_shift_label = "˚"},
  {"$", "£", 1.0, Code, KEY_RIGHTBRACE, .altgr_label = "¤", .altgr_shift_label = "¯"},
  {"", "", 0.0, EndRow},

  {"Caps", "Caps", 1.0, Mod, CapsLock, .scheme = 1},
  {"q", "Q", 1.0, Code, KEY_A, .altgr_label = "@", .altgr_shift_label = "Ω"},
  {"s", "S", 1.0, Code, KEY_S, .altgr_label = "ß", .altgr_shift_label = "ẞ"},
  {"d", "D", 1.0, Code, KEY_D, .altgr_label = "ð", .altgr_shift_label = "Ð"},
  {"f", "F", 1.0, Code, KEY_F, .altgr_label = "đ", .altgr_shift_label = "ª"},
  {"g", "G", 1.0, Code, KEY_G, .altgr_label = "ŋ", .altgr_shift_label = "Ŋ"},
  {"h", "H", 1.0, Code, KEY_H, .altgr_label = "ħ", .altgr_shift_label = "Ħ"},
  {"j", "J", 1.0, Code, KEY_J, .altgr_label = "◌̉", .altgr_shift_label = "◌̛"},
  {"k", "K", 1.0, Code, KEY_K, .altgr_label = "ĸ", .altgr_shift_label = "&"},
  {"l", "L", 1.0, Code, KEY_L, .altgr_label = "ł", .altgr_shift_label = "Ł"},
  {"m", "M", 1.0, Code, KEY_SEMICOLON, .altgr_label = "µ", .altgr_shift_label = "º"},
  {"ù", "%", 1.0, Code, KEY_APOSTROPHE, .altgr_label = "^", .altgr_shift_label = "ˇ"},
  {"*", "µ", 1.0, Code, KEY_BACKSLASH, .altgr_label = "`", .altgr_shift_label = "˘"},
  {"Enter", "Enter", 1.5, Code, KEY_ENTER, .scheme = 1},
  {"", "", 0.0, EndRow},

  {"⇧", "⇫", 1.5, Mod, Shift, .scheme = 1},
  {"<", ">", 1.0, Code, KEY_102ND, .altgr_label = "|", .altgr_shift_label = "¦"},
  {"w", "W", 1.0, Code, KEY_Z, .altgr_label = "ł", .altgr_shift_label = "Ł"},
  {"x", "X", 1.0, Code, KEY_X, .altgr_label = "»", .altgr_shift_label = ">"},
  {"c", "C", 1.0, Code, KEY_C, .altgr_label = "¢", .altgr_shift_label = "©"},
  {"v", "V", 1.0, Code, KEY_V, .altgr_label = "„", .altgr_shift_label = "‚"},
  {"b", "B", 1.0, Code, KEY_B, .altgr_label = "“", .altgr_shift_label = "‘"},
  {"n", "N", 1.0, Code, KEY_N, .altgr_label = "”", .altgr_shift_label = "’"},
  {",", "?", 1.0, Code, KEY_M, .altgr_label = "´", .altgr_shift_label = "˝"},
  {";", ".", 1.0, Code, KEY_COMMA, .altgr_label = "•", .altgr_shift_label = "×"},
  {":", "/", 1.0, Code, KEY_DOT, .altgr_label = "·", .altgr_shift_label = "÷"},
  {"!", "§", 1.0, Code, KEY_SLASH, .altgr_label = "◌̣", .altgr_shift_label = "˙"},
  {"↑", "↑", 1.0, Code, KEY_UP, .scheme = 1},
...
static struct key keys_symbols_fr[] = {
  {"Esc", "Esc", 1.25, Code, KEY_ESC, .scheme = 1},
  {"1", "1", 1.0, Code, KEY_1, 0, Shift, .reset_mod = true},
  {"2", "2", 1.0, Code, KEY_2, 0, Shift, .reset_mod = true},
  {"3", "3", 1.0, Code, KEY_3, 0, Shift, .reset_mod = true},
  {"4", "4", 1.0, Code, KEY_4, 0, Shift, .reset_mod = true},
  {"5", "5", 1.0, Code, KEY_5, 0, Shift, .reset_mod = true},
  {"6", "6", 1.0, Code, KEY_6, 0, Shift, .reset_mod = true},
  {"7", "7", 1.0, Code, KEY_7, 0, Shift, .reset_mod = true},
  {"8", "8", 1.0, Code, KEY_8, 0, Shift, .reset_mod = true},
  {"9", "9", 1.0, Code, KEY_9, 0, Shift, .reset_mod = true},
  {"0", "0", 1.0, Code, KEY_0, 0, Shift, .reset_mod = true},
  {"⌫", "⌫", 1.5, Code, KEY_BACKSPACE, .scheme = 1},
  {"", "", 0.0, EndRow},

  {"Tab", "Tab", 1.25, Code, KEY_TAB, .scheme = 1},
  {"@", "@", 1.0, Code, KEY_0, 0, AltGr, .reset_mod = true},
  {"#", "#", 1.0, Code, KEY_3, 0, AltGr, .reset_mod = true},
  {"€", "€", 1.0, Code, KEY_E, 0, AltGr, .reset_mod = true},
  {"$", "$", 1.0, Code, KEY_RIGHTBRACE},
  {"£", "£", 1.0, Code, KEY_RIGHTBRACE, 0, Shift, .reset_mod = true},
  {"%", "%", 1.0, Code, KEY_APOSTROPHE, 0, Shift, .reset_mod = true},
  {"&", "&", 1.0, Code, KEY_1},
  ...
  {"Home", "Home", 1.25, Code, KEY_HOME, .scheme = 1},
  {"+", "+", 1.0, Code, KEY_EQUAL, 0, Shift, .reset_mod = true},
  {"-", "-", 1.0, Code, KEY_6},
  {"=", "=", 1.0, Code, KEY_EQUAL},
  {"/", "/", 1.0, Code, KEY_DOT, 0, Shift, .reset_mod = true},
  {"\\", "\\", 1.0, Code, KEY_8, 0, AltGr, .reset_mod = true},
  {"|", "|", 1.0, Code, KEY_102ND, 0, AltGr, .reset_mod = true},
  {"~", "~", 1.0, Code, KEY_GRAVE, 0, Shift, .reset_mod = true},
  {"^", "^", 1.0, Code, KEY_9, 0, AltGr, .reset_mod = true},
  {"`", "`", 1.0, Code, KEY_7, 0, AltGr, .reset_mod = true},
  {"_", "_", 1.0, Code, KEY_8},
  {"Ins", "Ins", 1.5, Code, KEY_INSERT, .scheme = 1},
  {"", "", 0.0, EndRow},

  {"End", "End", 1.25, Code, KEY_END, .scheme = 1},
  {"<", "<", 1.0, Code, KEY_102ND},
  {">", ">", 1.0, Code, KEY_102ND, 0, Shift, .reset_mod = true},
  {"[", "[", 1.0, Code, KEY_5, 0, AltGr, .reset_mod = true},
  {"]", "]", 1.0, Code, KEY_MINUS, 0, AltGr, .reset_mod = true},
  {"{", "{", 1.0, Code, KEY_4, 0, AltGr, .reset_mod = true},
  {"}", "}", 1.0, Code, KEY_EQUAL, 0, AltGr, .reset_mod = true},
  {"\"", "\"", 1.0, Code, KEY_3},
  {"'", "'", 1.0, Code, KEY_4},
  {"°", "°", 1.0, Code, KEY_MINUS, 0, Shift, .reset_mod = true},
  {"§", "§", 1.0, Code, KEY_SLASH, 0, Shift, .reset_mod = true},
  {"Enter", "Enter", 1.5, Code, KEY_ENTER, .scheme = 1},
  {"", "", 0.0, EndRow},

  {"PgUp", "PgUp", 1.25, Code, KEY_PAGEUP, .scheme = 1},
  {"!", "!", 1.0, Code, KEY_SLASH},
  {"?", "?", 1.0, Code, KEY_M, 0, Shift, .reset_mod = true},
  {":", ":", 1.0, Code, KEY_DOT},
  {";", ";", 1.0, Code, KEY_COMMA},
  {",", ",", 1.0, Code, KEY_M},
  {".", ".", 1.0, Code, KEY_COMMA, 0, Shift, .reset_mod = true},
  {"²", "²", 1.0, Code, KEY_GRAVE},
  {"µ", "µ", 1.0, Code, KEY_BACKSLASH, 0, Shift, .reset_mod = true},
  {"«", "«", 1.0, Code, KEY_W, 0, AltGr, .reset_mod = true},
  {"»", "»", 1.0, Code, KEY_X, 0, AltGr, .reset_mod = true},
...
static struct key keys_symbols_us[] = {
  {"Esc", "Esc", 1.25, Code, KEY_ESC, .scheme = 1},
  {"1", "1", 1.0, Code, KEY_1},
  {"2", "2", 1.0, Code, KEY_2},
  {"3", "3", 1.0, Code, KEY_3},
  ...
  {"Tab", "Tab", 1.25, Code, KEY_TAB, .scheme = 1},
  {"@", "@", 1.0, Code, KEY_2, 0, Shift, .reset_mod = true},
  {"#", "#", 1.0, Code, KEY_3, 0, Shift, .reset_mod = true},
  {"€", "€", 1.0, Code, KEY_5, 0, AltGr, .reset_mod = true},
  {"$", "$", 1.0, Code, KEY_4, 0, Shift, .reset_mod = true},
  {"£", "£", 1.0, Code, KEY_4, 0, Shift | AltGr, .reset_mod = true},
  {"%", "%", 1.0, Code, KEY_5, 0, Shift, .reset_mod = true},
  {"&", "&", 1.0, Code, KEY_7, 0, Shift, .reset_mod = true},
  {"*", "*", 1.0, Code, KEY_8, 0, Shift, .reset_mod = true},
  {"(", "(", 1.0, Code, KEY_9, 0, Shift, .reset_mod = true},
  {")", ")", 1.0, Code, KEY_0, 0, Shift, .reset_mod = true},
  {"Del", "Del", 1.5, Code, KEY_DELETE, .scheme = 1},
  {"", "", 0.0, EndRow},
  ...
  {"|", "|", 1.0, Code, KEY_102ND, 0, Shift, .reset_mod = true},
  {"~", "~", 1.0, Code, KEY_GRAVE, 0, Shift, .reset_mod = true},
  {"^", "^", 1.0, Code, KEY_6, 0, Shift, .reset_mod = true},
  {"`", "`", 1.0, Code, KEY_GRAVE},
  {"_", "_", 1.0, Code, KEY_MINUS, 0, Shift, .reset_mod = true},
  {"Ins", "Ins", 1.5, Code, KEY_INSERT, .scheme = 1},
  {"", "", 0.0, EndRow},
  ...
  {"]", "]", 1.0, Code, KEY_RIGHTBRACE},
  {"{", "{", 1.0, Code, KEY_LEFTBRACE, 0, Shift, .reset_mod = true},
  {"}", "}", 1.0, Code, KEY_RIGHTBRACE, 0, Shift, .reset_mod = true},
  {"\"", "\"", 1.0, Code, KEY_APOSTROPHE, 0, Shift, .reset_mod = true},
  {"'", "'", 1.0, Code, KEY_APOSTROPHE},
  {"°", "°", 1.0, Code, KEY_SEMICOLON, 0, Shift | AltGr, .reset_mod = true},
  {"§", "§", 1.0, Code, KEY_S, 0, Shift | AltGr, .reset_mod = true},
  {"Enter", "Enter", 1.5, Code, KEY_ENTER, .scheme = 1},
  {"", "", 0.0, EndRow},

  {"PgUp", "PgUp", 1.25, Code, KEY_PAGEUP, .scheme = 1},
  {"!", "!", 1.0, Code, KEY_1, 0, Shift, .reset_mod = true},
  {"?", "?", 1.0, Code, KEY_SLASH, 0, Shift, .reset_mod = true},
  {":", ":", 1.0, Code, KEY_SEMICOLON, 0, Shift, .reset_mod = true},
  {";", ";", 1.0, Code, KEY_SEMICOLON},
  {",", ",", 1.0, Code, KEY_COMMA},
  {".", ".", 1.0, Code, KEY_DOT},
  {"²", "²", 1.0, Code, KEY_2, 0, AltGr, .reset_mod = true},
  {"µ", "µ", 1.0, Code, KEY_M, 0, AltGr, .reset_mod = true},
  {"«", "«", 1.0, Code, KEY_LEFTBRACE, 0, AltGr, .reset_mod = true},
  {"»", "»", 1.0, Code, KEY_RIGHTBRACE, 0, AltGr, .reset_mod = true},
  {"↑", "↑", 0.75, Code, KEY_UP, .scheme = 1},
  {"PgDn", "PgDn", 0.75, Code, KEY_PAGEDOWN, .scheme = 1},
  {"", "", 0.0, EndRow},
...
static struct key keys_index[] = {
  ...
  {"Symbols", "Symbols", 1.0, Layout, 0, &layouts[SymbolsUs], .scheme = 1},
